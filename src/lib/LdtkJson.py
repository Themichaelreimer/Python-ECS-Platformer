"""
    This library is only distributed as a .py file on the official ldtk website, and is not available
    via pip to my knowledge. 
    Accessed from https://ldtk.io/files/quicktype/LdtkJson.py at 2021-11-13T17:30:00
"""
